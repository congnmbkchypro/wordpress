...
function docx_tgm_init() {
    ...
    $plugins = array(
        ...
        array(
            'name'     => esc_html('WordPress Popular Posts', 'fashionate'),
            'slug'     => 'wordpress-popular-posts',
            'required' => false
        ),

        array(
            'name'     => esc_html('Woocommerce', 'fashionate'),
            'slug'     => 'woocommerce',
            'required' => false,
        ...
        array(
            'name'     => esc_html('Contact Form 7', 'fashionate'),
            'slug'     => 'contact-form-7',
            'required' => false,
        ),
...
add_action( 'tgmpa_register', 'docx_tgm_init' );